...
namespace MemoriaCurtar.Bot.Models
{
    ...
    {
        private IClassifierService _quoteService;
...
";
        ...
        private ICollection<MCQuote> ExtractQuotes(string text, ResponseItem item, string[] keywords)
        {
            
            var ret = new List<MCQuote>();
            var quotes = _quoteService.GetQuotes(text);
